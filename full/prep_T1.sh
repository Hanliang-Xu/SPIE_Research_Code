...
in_dir=$1
gpu=$2
atlas_dir=/home-local/dt1/code/full
...
# Rigidly register to MNI template:
# - T12mni_0GenericAffine.mat
# - T1_N4_mni_1mm.nii.gz
...
# Move data to MNI at 1mm and 2mm
# - T1_N4_mni_*mm.nii.gz (1mm from previous step)
# - T1_mask_mni_*mm.nii.gz
# - T1_seed_mni_*mm.nii.gz
# - T1_5tt_mni_*mm.nii.gz
# - T1_gmwmi_mni_*mm.nii.gz
# - T1_tractseg_mni_*mm.nii.gz
# - T1_slant_mni_*mm.nii.gz
